package com.yanke.owneruser.controller;
...
import com.yanke.common.annotation.Log;
import com.yanke.common.controller.BaseController;
import com.yanke.common.utils.ShiroUtils;
import com.yanke.owneruser.comment.GenerateCode;
import com.yanke.owneruser.comment.SMSContent;
import com.yanke.owneruser.comment.SMSPlatform;
import com.yanke.owneruser.comment.SMSTemplate;
import com.yanke.owneruser.domain.OwnerUserDO;
import com.yanke.owneruser.service.OwnerUserService;
import com.yanke.smsservice.service.ISMSService;
    ...
    Map<String, String> captcha(String phone, String type) {
        ...
        try {
            if (phone == null || "".equals(phone)) {
                ...
                Map<String, Object> map = sMSService.sendCodeNumber(SMSPlatform.yanke, phone, contentType);
                if (map == null) {
